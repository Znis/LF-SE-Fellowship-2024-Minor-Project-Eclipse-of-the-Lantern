...
export const axeLeft: sprite = {
    ...
    offset: [ 
        {x: 12, y: 10}, {x: 0, y: 10}, {x: -24, y: 18}, {x: -24, y: 32}, {x: -28, y: 44}, {x: -26, y:32}, {x: -24, y: 18}, {x: 12, y: 10},
    ],
...
export const axeRight: sprite = {
    ...
    offset: [ 
        {x: -25, y: 10}, {x: 10, y: 10}, {x: 20, y: 28}, {x: 20, y: 44}, {x: 20, y: 28}, {x: 20, y:20}, {x: -12, y: 10}, {x: -24, y: 10},
    ],
