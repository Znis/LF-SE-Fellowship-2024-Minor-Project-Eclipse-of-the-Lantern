...
this.isHoveringCloseButton = false;
    ...
    drawCloseButton(ctx: CanvasRenderingContext2D, color: string, closeButtonX:number, closeButtonY:number, closeButtonSize:number) {
        ctx.beginPath();
    ...
    show(ctx: CanvasRenderingContext2D = stateVariables.ctx){
        ...
        this.drawRoundedRect(ctx, rectX, rectY, this.w, this.h, this.borderRadius);
            ...
            this.drawCloseButton(ctx, color, closeButtonX, closeButtonY, closeButtonSize);
            ...
            canvas.addEventListener('mousemove', (e) => {
                ...
                this.isHoveringCloseButton = mouseX > closeButtonX && mouseX < closeButtonX + closeButtonSize &&
